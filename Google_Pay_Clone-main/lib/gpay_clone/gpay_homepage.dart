...
import 'package:gpay_clone/gpay_clone/qrscanner.dart';

import 'nameofbank.dart';
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            Padding(
              padding:
              const EdgeInsets.symmetric(vertical: 45.0, horizontal: 25.0),
              child: Row(
                  ...
                  GestureDetector(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const BankId()),
                        );
                      },
                    ...
                    Text(
                      ...
                      Column(
                        ...
                        children: [
                          Container(
                            width: 55.0,  // Set the desired width
